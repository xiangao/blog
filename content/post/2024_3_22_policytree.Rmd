...
The IPW loss can be not robust to model misspecification. Athey and Wager (2018) proposed a loss function that is robust to model misspecification.  The loss function is based on the doubly robust estimator, AIPW.
