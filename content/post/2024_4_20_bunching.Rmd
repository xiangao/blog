...
(1) estimate $E[Y_i | T_i = \bar_T, X_i ]$ non-parametrically 

(2) do a local linear regression $E[Y_i | T_i = \bar_T, X_i ] -Y_i$  onto $T_i$ at $\bar T$, using only observations such that $T_i > \bar T$. 
