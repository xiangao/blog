...
$Z$ is an NCE if $Y(a,z) = Y(a)$ and $Z \perp Y(a) | U$, meaning that $Z$ satisfies the exclusion restriction that there is no direct link from $Z$ to $Y$, and that $Z$ is independent of $Y$ given $U$.  This means $Z$ is an instrument for $A$.
