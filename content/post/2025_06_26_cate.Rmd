...
```{r doubleml1, include=TRUE, warning=FALSE,  cache=TRUE, message=FALSE, echo=TRUE}
...
```{r doubleml2, include=TRUE, warning=FALSE,  cache=TRUE, message=FALSE, echo=TRUE}
...
```{r aipw1, include=TRUE, warning=FALSE,  cache=TRUE, message=FALSE, echo=TRUE}
library(npcausal)
...
```{r aipw2, include=TRUE, warning=FALSE,  cache=TRUE, message=FALSE, echo=TRUE}
library(AIPW)
