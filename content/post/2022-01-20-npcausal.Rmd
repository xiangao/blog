...
where $P_n$ means sample mean.  This is the familiar AIPW estimator.  It is known to be doubly robust.  Since we know the influence function, we can calculate its variance, and thus the variance of the estimator, regardless of how the nuisance parameters are estimated.
...
```{r, include = T, echo = TRUE, warning=FALSE}
